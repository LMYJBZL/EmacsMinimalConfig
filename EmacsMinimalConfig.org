...
#+AUTHOR: Baojie
#+DATE: Time-stamp: <2026-04-20 08:06:35 baojie>
:PROPERTIES:
#+STARTUP: content
...
(use-package window
  ...
  (display-buffer-alist
   `(;; ========== 完全不显示的 buffer ==========
     ...
     ;; ========== 底部非侧边窗口（可复用，并自动获得焦点） ==========
     ;; Magit Status：底部显示，高度自适应内容
     ((derived-mode . magit-status-mode)
      (display-buffer-reuse-mode-window display-buffer-at-bottom)
      (window-height . (lambda (w) (fit-window-to-buffer w nil 1)))   ; 强制缩小
      (inhibit-switch-frame . t)
      (dedicated . t)
      (body-function . select-window))

     ;; Flymake 诊断、Messages、Backtrace 等
     ...
     ;; Shell / Eshell / Comint 模式
     ((or . ((derived-mode . shell-mode)
  ...
  ;; 其他窗口相关设置（可选）
  :config
  ;; 如果你想进一步缩小 Magit 窗口的最小高度限制，可以取消下面的注释：
